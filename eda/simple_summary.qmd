...
Every year, the North Carolina Rating Bureau publishes the Workers Comp Loss Costs by class of business. Insurers use these loss costs to form the rates for Workers Compensation insurance policies.

### Simple Trends in Loss Costs

These views track the change in approved loss costs over time.
